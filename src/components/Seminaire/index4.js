...
if(props.data.seminaire){
  ...
  <Card className={classes.root} style={{marginBottom:"30px"}}>
      <div className={classes.details}>
        ...
        <span style={{fontSize:"40px",fontWeight:"bold",marginLeft:"30px"}}> {seminaire.name}</span> 
        <br/>
        <span style={{fontSize:"30px",fontWeight:"italic",marginLeft:"40px"}}> {seminaire.ville}</span> 
          {/* </Typography> */}
        ...
        <div className={classes.controls}>
            <span style={{display:"flex"}}>
                <span style={{display:"flex",flexDirection: "column",marginLeft:"40px",marginRight:"30"}}>
                    <span style={{fontSize:"20px",fontWeight:"bold"}}>{seminaire.jour}</span>
                    <span style={{fontSize:"70px",color:"red"}}>{seminaire.date}</span>
        <span style={{fontSize:"20px",fontWeight:"bold"}}>{seminaire.moi} {" "}{seminaire.annee}</span>
        <span style={{fontSize:"20px",fontWeight:"bold",color:"red"}}>{seminaire.heure}</span>
                </span>
                <div className="vl"></div>
                {/* adress */}
                <span style={{display:"flex",flexDirection: "column",marginLeft:"40px",marginRight:"40px"}}>
                    <span style={{fontSize:"30px",color:"green"}}>{seminaire.lieu}</span>
                    <br/>
