    ...
    <div className="post featured">
      <a href="#">
        ...
        <div className="content">
            <h2 className="name" style={{marginBottom:"2px"}}>{festival.name}</h2>
          <h4 className="ville">{festival.ville}</h4>
          <span style={{display:"flex"}}>

<span style={{display:"flex",flexDirection: "column",marginLeft:"20px",marginRight:"20"}}>
    <span style={{fontSize:"15px",fontWeight:"bold"}} >{festival.jour}</span>
    <span style={{fontSize:"30px",color:"red"}}>{festival.date}</span>
    <span style={{fontSize:"15px",fontWeight:"bold"}}>{festival.moi} {" "}{festival.annee}</span>
    <span style={{fontSize:"15px",fontWeight:"bold",color:"red"}}>{festival.heure}</span>
</span>

<div className="vl"></div>
{/* adress */}
<span style={{display:"flex",flexDirection: "column",marginLeft:"10px",marginRight:"10px"}}>
    <span id="lieu">{festival.lieu}</span>
